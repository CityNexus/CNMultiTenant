    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                @endcan
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect @if(isset($section) && $section == 'datasets') active @endif "><i class="fa fa-help"></i> <span> Help </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">

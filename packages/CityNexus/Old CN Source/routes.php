...
Route::post("api-query", '\CityNexus\CityNexus\Http\APIController@addTo');
...
Route::group(['prefix' => "/citynexus/help"], function(){
    Route::get('item', '\CityNexus\CityNexus\Http\HelpController@getItem');
    Route::get('submit-ticket', '\CityNexus\CityNexus\Http\HelpController@getSubmitTicket');
    Route::post('submit-ticket', '\CityNexus\CityNexus\Http\HelpController@postSubmitTicket');
});
...
//
//
//    if($user = \CityNexus\User::where('activation', $token)->first())
//    {
...
Route::group([], function() {
    ...
    Route::get('/dashboard', 'CityNexus\CityNexus\Http\CityNexusController@getIndex');
